  unsigned char bytes[] = {0x13 ,0x37};
  int size = sizeof(bytes);
unsigned char bytes1[] = {0x1 ,0x2, 0x3, 0x4};
int size1 = sizeof(bytes1);
  unsigned char bytes2[] = {0x05 ,0x04, 0x03, 0x02,0x01};
  int size2 = sizeof(bytes2);
unsigned char bytes3[] = {0x01 ,0x02, 0x03, 0x04};
int size3 = sizeof(bytes3);
unsigned char bytes4[] = {0x01 ,0x02, 0x03,0x00,0xFF,0xA1, 0x04};
int size4 = sizeof(bytes4);
void setup() {
...
unsigned short x1 = Compute_CRC16 (bytes,size);
unsigned short x2 = Compute_CRC16 (bytes1,size1);
unsigned short x3 =Compute_CRC16 (bytes2,size2);
unsigned short x4 =Compute_CRC16 (bytes3,size3);
unsigned short x5 =Compute_CRC16 (bytes4,size4);
Serial.print("0x13 ,0x37: ");
Serial.println(x1,HEX);
Serial.print("0x1 ,0x2, 0x3, 0x4: ");
Serial.println(x2,HEX);
Serial.print("0x05 ,0x04, 0x03, 0x02,0x01: ");
Serial.println(x3,HEX);
Serial.print("0x01 ,0x02, 0x03, 0x04: ");
Serial.println(x4,HEX);
Serial.print("0x01 ,0x02, 0x03,0x00,0xFF,0xA1, 0x04: ");
